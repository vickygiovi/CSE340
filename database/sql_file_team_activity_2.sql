...
ALTER TABLE message
ADD CONSTRAINT fk_sender FOREIGN KEY (sender_id) REFERENCES account(account_id),
    ADD CONSTRAINT fk_recipient FOREIGN KEY (recipient_id) REFERENCES account(account_id),
    ADD CONSTRAINT fk_inv FOREIGN KEY (inv_id) REFERENCES inventory(inv_id);
...
INSERT INTO message (body, sender_id, recipient_id, inv_id)
VALUES ('Hello', 9, 11, 1);
SELECT *
FROM message
...
SELECT message.body,
    ...
    message.inv_id,
    a1.account_firstname as FirstNameSender,
    a1.account_lastname as LastNameSender,
    a2.account_firstname as FirstNameRecipient,
    a2.account_lastname as LastNameRecipient
FROM message
